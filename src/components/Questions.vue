  ...
  <div class="edit">
    <el-row class="edit_content">
      <el-col class="addmp4" :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
        ...
        <p>答案及解答</p>
        <div id="wangeditor2">
          <div ref="editorElem2" style="text-align: left"></div>
        </div>
        <el-button
          type="primary"
          v-show="!isShow"
...
export default {
  ...
  methods: {
    ...
    btn() {
      ...
      //获取第二个编辑器内容
      let ehtml2 = this.editor2.txt.html();
    ...
    if (this.$route.query.key) {
      ...
      axiosHttp({
        ...
        .then(function (response) {
          ...
          _this.editor2.txt.html(response.data[0].ehtml2);
  ...
  mounted() {
    ...
    this.editor = editor;
    //答案编辑器
    const editor2 = new wangEditor(this.$refs.editorElem2);
    // 配置 onchange 回调函数，将数据同步到 vue 中
